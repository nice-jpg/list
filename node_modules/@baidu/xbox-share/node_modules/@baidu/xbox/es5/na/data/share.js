...
var _default = function _default(data) {
  ...
  if ((0, _version_compare.default)(version, '5.3.5') >= 0 || (0, _isMatrix.default)()) {
    if ((0, _detect.isAndroid)()) {
      (0, _android.prompt)('Bdbox_android_utils', 'callShare', [JSON.stringify(data), 'android_share_scuucess', 'android_share_fail']);
    } else {
      (0, _ios.invokeApp)('callShare', {
