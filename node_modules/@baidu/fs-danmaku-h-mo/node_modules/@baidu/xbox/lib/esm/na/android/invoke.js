 ...
 * @return 发起schema请求
 */
export function androidInvoke(schema) {
    if (!isWindow(globalObject)) {
        return;
    }
    const androidJsBridge = globalObject === null || globalObject === void 0 ? void 0 : globalObject.Bdbox_android_jsbridge;
    if (androidJsBridge) {
        return androidJsBridge === null || androidJsBridge === void 0 ? void 0 : androidJsBridge.dispatch(schema);
    }
    return globalObject === null || globalObject === void 0 ? void 0 : globalObject.prompt('Bdbox_android_jsbridge', 'dispatch', schema);
}
/**
 * 老版本的调起，prompt实现
...
export function prompt(obj, func, args) {
    ...
    return globalObject === null || globalObject === void 0 ? void 0 : globalObject.prompt(`BdboxApp:${data}`);
}
/**
 ...
 * @return 返回对象格式的json
 */
export function command(intent, mode = '0', commandClass = '', minVersion = '') {
    const commandParams = {
        mode,
        intent,
    };
 ...
 * @param schema 调起协议
 */
export function androidSyncInvoke(schema) {
    if (!isWindow(globalObject)) {
        return null;
    }
    const androidJsBridge = globalObject === null || globalObject === void 0 ? void 0 : globalObject.Bdbox_aiapps_jsbridge;
    if (androidJsBridge) {
        return androidJsBridge === null || androidJsBridge === void 0 ? void 0 : androidJsBridge.dispatch(schema);
    }
    return null;
