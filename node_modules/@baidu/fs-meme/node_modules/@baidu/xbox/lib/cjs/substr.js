...
exports.substr = exports.str2array = void 0;
var rsAstralRange = '\ud800-\udfff';
var rsZWJ = '\u200d';
var rsVarRange = '\ufe0e\ufe0f';
var rsComboMarksRange = '\u0300-\u036f';
var rsComboHalfMarksRange = '\ufe20-\ufe2f';
...
var rsOptMod = rsModifier + "?";
var rsAstral = "[" + rsAstralRange + "]";
var rsNonAstral = "[^" + rsAstralRange + "]";
var rsOptJoin = "(?:" + rsZWJ + "(?:" + rsNonAstral + "|" + rsRegional + "|" + rsSurrPair + ")" + rsOptVar + rsOptMod + ")*";
var rsSeq = rsOptVar + rsOptMod + rsOptJoin;
var rsSymbol = "(?:" + rsNonAstral + rsCombo + "?|" + rsCombo + "|" + rsRegional + "|" + rsSurrPair + "|" + rsAstral + ")";
...
var hasUnicode = function (val) { return reHasUnicode.test(val); };
var unicodeToArray = function (val) { return val.match(reUnicode) || []; };
var asciiToArray = function (val) { return val.split(''); };
/**
 * 将字符转换为数组，方便进行截取
 *
 * emoji表情case示例：
 ...
 */
function str2array(val, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.hasEmoji, hasEmoji = _c === void 0 ? false : _c, _d = _b.emojiMaxLen, emojiMaxLen = _d === void 0 ? 8 : _d, _e = _b.emojiData, emojiData = _e === void 0 ? [] : _e;
    if (!hasEmoji) {
        return hasUnicode(val) ? unicodeToArray(val) : asciiToArray(val);
    }
    var rsEmoji = emojiData.length
        ? emojiData.map(function (item) { return item.replace('[', '\\[').replace(']', '\\]'); }).join('|')
        : "\\[.{1," + (emojiMaxLen - 2) + "}?\\]";
...
function substr(str, start) {
    ...
    var hasLength = typeof rest[0] === 'number';
    var data = hasLength ? str2array(str, rest[1]) : str2array(str, rest[0]);
    var ret = hasLength ? data.splice(start, rest[0]) : data.splice(start);
    return ret.join('');
}
