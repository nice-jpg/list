...
var _default = function _default(data) {
  ...
  if ((0, _detect.isAndroid)() && ((0, _version_compare.default)(version, '7.7') >= 0 || other)) {
    (0, _android.prompt)('Bdbox_android_utils', 'setToolBarIcons', [JSON.stringify(data)]);
    return Promise.resolve();
  }

  if ((0, _detect.isIOS)() && ((0, _version_compare.default)(version, '7.7') >= 0 || other)) {
