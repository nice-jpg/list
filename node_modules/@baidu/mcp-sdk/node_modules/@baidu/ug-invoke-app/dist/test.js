...
function matchedUlink(browser, appName) {
  ...
  console.warn('matchedUlink判定结果：', matchIosWithVersion && !notUlink);
...
async function invokeWithType(options, invokeType) {
  ...
  if (invokeType === InvokeType.ULINK) {
    ...
    console.warn('最终ulink：', options.ulink);
...
const App = san_dev.defineComponent({
  template: `
        <div id="app">
            ...
            <div s-if="showWxTag" class="btn wx-test" id="baiduboxapp-wx">微信开放标签调起测试</div>
            ...
            <div class="cut">===========================================</div>
            <button class="btn" on-click="invokeQuanminByUlink">ulink调起度小视</button>
            <button class="btn" on-click="invokeQuanmin">scheme调起度小视</button>
            ...
            <div class="cut">============================================</div>
            <button class="btn" on-click="invokeBaiduboxvisionByUlink">ulink调百度青春版</button>
            <button class="btn" on-click="invokeBaiduboxvision">scheme调百度青春版</button>
            ...
            <div class="cut">============================================</div>
            <button class="btn" on-click="invokeXiaoduappByUlink">ulink 调起 小度app</button>
            <button class="btn" on-click="invokeXiaoduapp">scheme调起 小度</button>
        </div>
    `,
  ...
  wxOpenTag(browser) {
    ...
    this.data.set('showWxTag', true);
    this.nextTick(() => {
      const targetDom = document.querySelector('#baiduboxapp-wx');
      const wxInfo = {
        appId: 'wx85d749f4a86cb9a9',
        nonceStr: 'NMvjxSxhZGyA5bq0',
        signature: 'ddf9ad04f21758198952d0d1d57f1a272990bdd3',
        timestamp: 1637827990,
        url: 'www.baidu.com'
      };
      createWxTag({
        appName: 'baiduboxapp',
        ...
        onClick() {
          console.log('onClick，这里只做模拟，无法真实调起');
        },
