...
export class PerformanceLog {
     ...
     formatData() {
        if (window.performanceTime && Object.prototype.toString.call(window.performanceTime) === '[object Object]') {
            ...
            this.allPerformanceTime = {
                ...
                }_${performanceTime.FPTimeStamp
                }_${performanceTime.FCPTimeStamp
                }_${performanceTime.FMPTimeStamp
                }_${performanceTime.TTITimeStamp
                }`,
            };
        }
        else {
    ...
    setIsFristEnter() {
        ...
        try {
            if (!first) { // 如果用户之前没进入过，也就是没有设置过first,拿到的null
...
export const performanceLogger =  new PerformanceLog();