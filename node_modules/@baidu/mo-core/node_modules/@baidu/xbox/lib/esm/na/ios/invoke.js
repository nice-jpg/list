...
export function isSchemaValid(schema) {
    return isString(schema) && schema.length > 10 && isWindow(globalObject);
}
/**
 ...
 */
export function iosInvoke(schema) {
 ...
 * });
 */
export function iosInvokeApp(action, params, callback, schemaHead = getSchemaHead()) {
    let queryObject = {};
 ...
 * @param schema 调起命令
 */
export function postMsgInvoke(schema) {
    var _a, _b, _c;
    if (isSchemaValid(schema)) {
        (_c = (_b = (_a = globalObject === null || globalObject === void 0 ? void 0 : globalObject.webkit) === null || _a === void 0 ? void 0 : _a.messageHandlers) === null || _b === void 0 ? void 0 : _b.BBAMNPJSBridge) === null || _c === void 0 ? void 0 : _c.postMessage(schema);
    }
}
/**
 ...
 * @param scheme 调起命令
 */
export function componentInvoke(schema) {
    var _a, _b, _c;
    if (isSchemaValid(schema)) {
        (_c = (_b = (_a = globalObject === null || globalObject === void 0 ? void 0 : globalObject.webkit) === null || _a === void 0 ? void 0 : _a.messageHandlers) === null || _b === void 0 ? void 0 : _b.BBAMNPJSBridgeWebViewComponent) === null || _c === void 0 ? void 0 : _c.postMessage(schema);
    }
}
/**
 * iosSyncInvoke
 ...
 * @return 返回结果
 */
export function iosSyncInvoke(schema) {
    if (!isSchemaValid(schema)) {
        return null;
    }
    return globalObject === null || globalObject === void 0 ? void 0 : globalObject.prompt(`BdboxApp:${stringify({
        obj: 'mnp',
        func: 'dispatch',
        args: [schema],
    })}`);
 ...
 * @param callback 回调函数
 */
export function invokeWithCallback(url, callback) {
