...
var _default = function _default(data) {
  ...
  if ((0, _detect.isAndroid)() && ((0, _version_compare.default)(version, '8.0') >= 0 || other)) {
    (0, _android.prompt)('Bdbox_android_utils', 'copy', [data, '__cmt_copyRn']);
    return Promise.resolve();
  } // IOS下判断能否使用端能力


  if ((0, _detect.isIOS)() && ((0, _version_compare.default)(version, '5.4') >= 0 || other)) {
    (0, _ios.invokeApp)('copy', {
      text: data,
      minver: '7.5.0.0'
    }, '__cmt_copyRn');
    return Promise.resolve();
