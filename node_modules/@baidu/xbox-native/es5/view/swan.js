...
(0, _register.default)('swan/open', {
  ...
  filter: function filter(data) {
    ...
    var cb = data.functionBeforeOpenSwan;

    if (cb && window[cb] && (0, _utils.isFunction)(window[cb])) {
      window[cb]();
    }
    ...
    if (path && path.length > 0) {
      for (var key in params) {
        params[key] = (0, _utils.encode)(params[key]);
      }
...
var _default = function _default() {
  ...
  return (0, _index.open)((0, _utils.getParams)('swan', params));
};
