...
(0, _register.default)('datachannel/register', {
  v: 5,
  versionRange: ['8.4'],
  hasCB: false,
  ...
  filter: function filter(data) {
    return {
      data: (0, _index.paramsFilter)(data)
    };
  }
});
...
var _default = function _default(params) {
  if ((0, _detect.isMatrix)('baiduboxvision')) {
    var invokeParams = (0, _index.paramsFilter)(params, false);
    ...
    (0, _invoke.default)("baiduboxapp://v5/datachannel/register?".concat((0, _xbox.json2query)(_objectSpread({}, invokeParams))));
    return Promise.resolve();
  }

  return (0, _index.on)(params);
};
