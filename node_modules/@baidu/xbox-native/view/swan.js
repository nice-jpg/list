...
import {encode, getParams, noEmptyQueryToJson, isFunction} from '../utils';
...
register('swan/open', {
    ...
    filter(data) {
        ...
        const cb = data.functionBeforeOpenSwan;
        if (cb && window[cb] && isFunction(window[cb])) {
            window[cb]();
        }
 ...
 */
export default (params = {}) => open(getParams('swan', params));
