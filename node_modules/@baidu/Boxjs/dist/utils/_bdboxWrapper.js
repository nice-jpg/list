/**
 * @file utils/_bdboxWrapper.js
 * @author gaojiexuan@baidu.com
 * @description 工具函数，统一包装bdbox老基础库和新写的
 */

/** import $ *//* istanbul ignore next */
/* eslint-disable */
var now = (+new Date());
var _id = (now + '').slice(-3);
...
/**
 * @function
 * @name supportedSDKVersion
 * @description 获取端支持的最低版本的【jssdk-端能力】版本号，解析ua？
 */

$.cbWithoutCache = function (cb, thunk) {
    var func = '_bdbox_js_' + $.getId();
