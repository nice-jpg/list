...
var defaultPKGName = 'com.baidu.searchbox';
//http://127.0.0.1:6259/getpackageinfo?callback=getinfo&packagename=com.baidu.searchbox
...
// var MOPLUS_BOXINFO = NEW_MOPLUS_HOST + 'getsearchboxinfo?mcmdf=' + MCMDF + '&callback=?';
...
var sampleStat = {
  ...
  parseUA: function() {
    ...
    var reg = {
      uc: /UCBrowser\/(\S*) \S*/g, // uc浏览器
      bd: /baidubrowser\/(\S*) \(Baidu/g, // baidu浏览器
      qq: /MQQBrowser\/(\S*) Mobile/g, // qq浏览器
      chr: /Chrome\/(\S*) Mobile/g, // chrome浏览器
      qh: /360 Aphone Browser \((\S*)\)/g, // 360浏览器
      sg: /SogouMobileBrowser\/(\S*)/g, // 搜狗浏览器
...
var Moplus = function(minversion, mcmdf, host) {
   ...
   * @type {string}
   */
  this.MCMDF = mcmdf || MCMDF;
  // this.MOPLUS_BOXINFO = this.host + 'getsearchboxinfo?mcmdf=' + this.MCMDF + '&callback=?';
