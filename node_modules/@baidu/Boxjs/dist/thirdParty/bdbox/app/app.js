...
proto._reg = function(controller) {
    ...
    controller._router = function(query, pathname, match) {
        ...
        //controller的 before
        controller.emit('before', controller.view, query, pathname)
            //doit
            .emit('main', controller.view, query, pathname, match)
            //after
            .emit('after', controller.view, query, pathname);
