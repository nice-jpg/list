...
var _tipCss = '.openBox-weixinTip .options .link {' +
    ...
    '}' +
    '.openBox-weixinTip *,' +
    '.openBox-weixinTip *:before,' +
    '.openBox-weixinTip *:after {' +
    ...
    '}' +
    '.openBox-weixinTip .main {' +
        '-webkit-box-flex: 1;' +
        'box-flex: 1;' +
        'padding: 0 35px;' +
    '}' +
    '.openBox-weixinTip .tips {' +
        'padding-top: 38px;' +
        'font-size: 15px;' +
        'color: #aaa;' +
    '}' +
    '.openBox-weixinTip .options dt {' +
        'padding: 13px 0px 9px;' +
    '}' +
    '.openBox-weixinTip .options dt .num {' +
        'float: left;' +
    ...
    '}' +
    '.openBox-weixinTip .options dt .case {' +
        'font-size: 17px;' +
        'padding-left: 6px;' +
    '}' +
    '.openBox-weixinTip .options dd {' +
        'padding-bottom: 24px;' +
        'margin-bottom: 8px;' +
        'line-height: 22.5px;' +
    '}' +
    '.openBox-weixinTip .options dd.bb {' +
        'border-bottom: 1px solid #efefef;' +
    '}' +
    '.openBox-weixinTip .options .wizard {' +
        'position: relative;' +
    '}' +
    '.openBox-weixinTip .options .wizard .arr {' +
        'position: absolute;' +
        'right: -10px;' +
        'top: -50px;' +
        'width: 40px;' +
        'height: 40px;' +
        'background: url(//s.bdstatic.com/common/openjs/openBox/wechatPop-arrow.png) no-repeat;' +
        '-webkit-background-size: cover;' +
        'background-size: cover;' +
    '}' +
    '.openBox-weixinTip .options .wizard .img {' +
        'padding-top: 18.033%;' +
        'width: 100%;' +
        'background: url(//s.bdstatic.com/common/openjs/openBox/wechatPop-wizard.png) no-repeat;' +
        '-webkit-background-size: cover;' +
        'background-size: cover;' +
    '}' +
    '.openBox-weixinTip .options .wizard p {' +
        'display: none;' +
    '}' +
    '.openBox-weixinTip .options .text {' +
        'font-size: 17px;' +
        'color: #777;' +
    '}' +
    '.openBox-weixinTip .options .link {' +
        'display: block;' +
    ...
    '}' +
    '.openBox-weixinTip .options .btn:active {' +
        'background-color: rgba(0, 0, 0, 0.1);' +
    '}' +
    '.openBox-weixinTip footer {' +
        'height: 115px;' +
    '}' +
    '.openBox-weixinTip footer .logo {' +
        'overflow: hidden;' +
        'margin: 0 auto;' +
        'width: 216px;' +
        'height: 63px;' +
        'text-indent: -9999px;' +
        'background: url(//s.bdstatic.com/common/openjs/openBox/wechatPop-logo.png) no-repeat;' +
        '-webkit-background-size: cover;' +
        'background-size: cover;' +
    '}' +
    '.openBox-weixinTip footer .copy {' +
        'margin-top: 15px;' +
        'text-align: center;' +
        'font-size: 10px;' +
        'color: #999;' +
...
function showWeiXinTip() {
    ...
    _tip.innerHTML =
        ...
        '<dl class="options">' +
        '<dt>' +
        '<span class="num">1</span> <span class="case">若您已安装手机百度</span>' +
        '</dt>' +
        '<dd class="bb">' +
        '<div class="wizard">' +
        '<div class="arr"></div>' +
        ...
        '<span class="case">若您尚未安装手机百度</span>' +
        '</dt>' +
        '<dd>' +
        '<a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.baidu.searchbox" class="btn">去Appstore下载</a>' +
        '</dd>' +
        '</dl>' +
        '</section>' +
        '<footer>' +
        '<div class="logo"><strong>手机百度</strong>' +
        '<p>百度一下 你就得到</p></div>' +
        '<div class="copy">Copyright © 2016 BAIDU Corporation. All rights reserved.</div>' +
        '</footer>';
...
//判断是否是框内分享出来，需要框内分享的URL上加isBdboxShare=1.
