...
export class EventEmitter {
    private readonly _events: EventMaps = {};
     ...
     */
    on(name: string, callback: EmitterListener, ctx: EmitterContext) {
        if (!isString(name)) {
     ...
     * @return 当前 emitter 实例
     */
    once(name: string, callback: EmitterListener, ctx: EmitterContext) {
     ...
     * @return 当前 emitter 实例
     */
    off(name: string, callback: EmitterListener) {
        const events = this._events;
