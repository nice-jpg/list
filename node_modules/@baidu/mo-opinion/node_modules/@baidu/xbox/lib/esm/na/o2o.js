 ...
 * ```
 */
export function o2o(url, opt, schemeHead) {
    ...
    // 2016.04.07
    const cclass = (opt === null || opt === void 0 ? void 0 : opt.component) || 'com.baidu.searchbox.wallet.WalletServiceActivity';
    const minver = (opt === null || opt === void 0 ? void 0 : opt.miv_v) || (opt === null || opt === void 0 ? void 0 : opt.minver) || '16783629';
    let intentParts = [`S.bdsb_light_start_url=${encode(url)}`];
    if (opt && isPlainObject(opt)) {
    ...
    command(intent, '0', cclass, minver);
}
