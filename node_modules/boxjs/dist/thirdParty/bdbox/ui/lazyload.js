  ...
  (function ($) {
    $.fn.picLazyLoad = function (settings) {
      ...
      settings = $.extend({
        threshold: 500,
        // 提前高度加载
        placeholder: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6Q' + 'AAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC'
      }, settings || {});
