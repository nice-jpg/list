module.exports = function () {
   ...
   *  list: ['文艺', '博客']
   * };
   * var res1 = template("test1", data1);
   * // <ul><li>索引 1: 文艺</li><li>索引 2: 博客</li></ul>
   * console.log(res1);
   ...
   *  code: 10
   * };
   * var res2 = Bdbox.template("test2", data2);
   * // <p>admin</p>
   * console.log(res2);
  
   * var source = "<ul> {{each list as value i}} <li>索引 {{i + 1}} ：{{value}}</li> {{/each}} </ul>";
   * var data3 = {list: ['摄影', '电影']};
   * var res3 = template.render(source)(data3);
   * // <ul><li>索引 1 ：摄影</li><li>索引 2 ：电影</li></ul>
   * console.log(res3);
  
   */

  /**@lends Bdbox.artTemplate*/
  ...
  defaults.parser = function (code, options) {
    ...
    switch (key) {
      ...
      default:
        ...
        if (args.indexOf('|') !== -1) {
          var escape = options.escape; // {{#value | link}}
