    ...
    if ($.$isIOS()) {
      ...
      var openNovel = function () {
        if (versionCompare(getVersion(), '6.3') >= 0) {
          var intent = '#Intent;component=com.baidu.searchbox/.discovery.novel.' + 'NovelHomeActivity;S.invoke_fragment=DiscoveryNovelHomeFragment;end';
