module.exports = function () {
  ...
  var winElement = window,
      ID,
      docElement = document,
      GIF_URI = '//m.baidu.com/static/searchbox/_analyze/f.gif'; //抽样
  // if (Date.now() % 2 === 1) {
  ...
  function checkSupportsForCSS(property) {
    var domProperty = '',
        ...
        cssAttributeNames = []; //border-radius ---->  BorderRadius
  ...
  var _FD = {
    ...
    runAllTest: function () {
      ...
      that.t('bxsd', checkSupportsForCSS, 'box-shadow'); // that.t('opat', checkSupportsForCSS, 'opacity');
      ...
      that.c(checkSupportsForWebPFormat, 'animation', webPCallback); // that.t('wsql', checkSupportsForWebSQL);
