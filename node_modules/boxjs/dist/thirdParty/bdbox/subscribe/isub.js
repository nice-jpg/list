module.exports = function () {
  ...
  subProto.createDom = function () {
    ...
    this.$toastOne = tTips; // 跳转toast dom
    ...
    scc.innerHTML = '<div class="subscribe-click-context">关注成功，请到“' + '<span class="subscribe-click-text2">首页-关注</span>”查看' + '</div>' + '<div class="subscribe-click-button" ontouchstart="">去查看</div>';
  ...
  subProto.subscribe = function (data, callback, failCallback, unlogin) {
    ...
    var receiveAPI = extHost + '/api/subscribe/v1/relation/receive?callback=?&' + toQuery(receiveData);

    var loginCallback = function (login) {
      var suc = login.errno;
      var isLogin = login.data.isLogin; // {"errno":10000,"request_id":"透传","errmsg":"透传","data":{}}
