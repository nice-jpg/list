 ...
 */
export declare class DynamicComponentReference extends ComponentReference {
    readonly specifier: string;
    readonly id: string;
    /**
     * 从 ComponentClass 解析时，可以引用到子组件的 ComponentClass
     */
    readonly componentClass: ComponentConstructor<{}, {}>;
    constructor(specifier: string, id: string, 
    /**
     * 从 ComponentClass 解析时，可以引用到子组件的 ComponentClass
     */
    componentClass: ComponentConstructor<{}, {}>);
}
export declare function componentID(isDefault: boolean, genID: string | (() => string)): string;
